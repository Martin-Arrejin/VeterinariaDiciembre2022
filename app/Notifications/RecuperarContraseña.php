...
class RecuperarContraseña extends Notification
{
    /**
    ...
    protected function buildMailMessage($url,$notifiable)
    {
        return (new MailMessage)
            ...
            ->action(Lang::get('Restablecimiento de contraseña'), $url)
            ...
            ->line(Lang::get('Si no solicitó un restablecimiento de contraseña, ignore este correo.'))
            ->salutation('¡Saludos!, ATTE Veterinaria San Agustin');
        }
